...
const ServiceCategoryList = ({ isRefetch = false }) => {
  ...
  function goToEdit(row) {
    dispatch(
      addMenu({
        ...
        id: 'service_category_edit',
        name: t('edit.service.category'),
      }),
    );
  ...
  const goToAddCategory = () => {
    dispatch(
      addMenu({
        id: 'service-category-add',
        url: 'service-category/add',
        name: t('add.service.category'),
      }),
    );
    navigate('/service-category/add');
  };
  ...
  const goToImport = () => {
    dispatch(
      addMenu({
        ...
        id: 'service_category_import',
        name: t('import.service.category'),
      }),
    );
  ...
  const goToClone = (uuid) => {
    dispatch(
      addMenu({
        id: `service-category-clone`,
        url: `service-category-clone/${uuid}`,
        name: t('service.category.clone'),
      }),
    );
  ...
  return (
    <>
      ...
      <Card title={t('service.categories')}>
        <Tabs
          className='mt-3'
          activeKey={immutable}
          onChange={(key) => {
